...
print("No of Years in School: ",schooling)
...
schooling = 13
print("Updated No of Years in School: ",schooling)
...
print("Variables can be updated, constants cannot beacuse they are immutable.")
