...
defender.moveRight()
print("Defender Postion: \(defender.position)")
...
print("Before Defender Shield Strength : \(defender.shieldStrength)")
defender.wasHit()
print("Defender Shield Strength : \(defender.shieldStrength)")
